...
function ContactPage() {
  return (
    <div className="mt-[100px] mb-12">
      <h2 className=' font-extrabold text-2xl text-sans text-center text-white'>Let&#39;s Work Together</h2>
  ...
  <div className="container mx-auto text-center px-4">
    ...
    <div className="relative max-w-md md:max-w-lg mx-auto bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-6 md:p-8 rounded-lg shadow-lg space-y-6">
      ...
      <div className="mt-8">
        <p className="text-md md:text-lg text-gray-300">Or connect with me on social media:</p>
